class CardServizi {
  ...
  CardServizi({
    ...
    required this.qMaxPrenotabile,
    required this.dataIni,
    required this.visibileApp,
    required this.visibileAppGuest,
    required this.pagamentoType,
    required this.percentualeAcconto,
    required this.orari, // Modificato per essere una lista
  });

  factory CardServizi.fromJson(Map<String, dynamic> json) {
    return CardServizi(
      lingua: json['lingua'] ?? '',
      nome: json['nome'] ?? '',
      ...
      qMaxPrenotabile: json['qMaxPrenotabile'] ?? 0,
      dataIni: json['dataIni'] ?? 0,
      visibileApp: json['visibileApp'] ?? true,
      visibileAppGuest: json['visibileAppGuest'] ?? true,
      pagamentoType: json['pagamentoType'] ?? '',
      percentualeAcconto: json['percentualeAcconto'] ?? 0,
