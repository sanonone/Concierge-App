...
function HotelCard(props) {
  ...
  const [formLinkSito, setFormLinkSito] = useState(linksito);
  ...
  return (
    <div className=" rounded-lg bg-white overflow-x-clip hover:scale-105 transition-transform shadow-xl shadow-slate-700/100">
      ...
      <div className=" h-60 overflow-y-auto rounded-t-lg">
        <img className=" " src={immagine} alt="immagine hotel"></img>
      </div>
      <div className="flex flex-col p-4">
        ...
        <input className="bg-slate-100 border-2 focus:outline-none focus:border-indigo-500 rounded-md h-9" type="text" name="nome" value={formImmagine} onChange={handleInputChangeImmagine} disabled={formLingua != "Italiano"} />
        ...
        />
        <h3 className=" text-indigo-700 underline font-medium">Link Sito:</h3>
        <input
          className="bg-slate-100 border-2 focus:outline-none focus:border-indigo-500 rounded-md h-9"
          type="text"
          name="nome"
          value={formLinkSito}
          onChange={handleInputChangeLinkSito}
